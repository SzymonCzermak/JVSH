...
class AIHandler {
  ...
  Future<String> getResponse(String message) async {
    try {
      String context =
          "Odpowiadaj możliwie najkrócej, ale kompleksowo, na pytania związane z filmem, aktorami, teatrem oraz pisarzami. Na pytania poza tym zakresem odpowiadaj, że to nie twoje kompetencje.";
      String fullMessage =
